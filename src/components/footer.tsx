        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-2">
              <a href="#" className="p-2 rounded-full border border-white/10 hover:border-primary-gold hover:text-primary-gold transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4 font-inter text-sm text-medium-gray">
              <li>
                <Link href="/novidades" className="hover:text-primary-gold hover:pl-2 transition-all duration-300 inline-block">
                  Novidades
                </Link>
              </li>
              <li>
                <Link href="/colecoes" className="hover:text-primary-gold hover:pl-2 transition-all duration-300 inline-block">
                  Coleções
                </Link>
              </li>
              <li>
                <Link href="/bestsellers" className="hover:text-primary-gold hover:pl-2 transition-all duration-300 inline-block">
                  Mais Vendidos
                </Link>
              </li>
              <li>
                <Link href="/presentes" className="hover:text-primary-gold hover:pl-2 transition-all duration-300 inline-block">
                  Guia de Presentes
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4 font-inter text-sm text-medium-gray">
              <li>
                <Link href="/sobre" className="hover:text-primary-gold hover:pl-2 transition-all duration-300 inline-block">
                  Sobre a Marca
                </Link>
              </li>
              <li>
                <Link href="/contato" className="hover:text-primary-gold hover:pl-2 transition-all duration-300 inline-block">
                  Fale Conosco
                </Link>
              </li>
              <li>
                <Link href="/politica-privacidade" className="hover:text-primary-gold hover:pl-2 transition-all duration-300 inline-block">
                  Política de Privacidade
                </Link>
              </li>
              <li>
                <Link href="/trocas" className="hover:text-primary-gold hover:pl-2 transition-all duration-300 inline-block">
                  Trocas e Devoluções
                </Link>
              </li>
            </ul>
