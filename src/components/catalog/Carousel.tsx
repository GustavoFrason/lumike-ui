    ...
    <section className="py-12">
      {(title || subtitle) && (
        <div className="mb-8 text-center px-6">
          {title && (
            <h2 className="text-3xl font-playfair font-bold text-zinc-900 mb-2 uppercase tracking-widest">
              {title}
            </h2>
          )}
          {subtitle && (
            <p className="text-zinc-500 font-inter text-sm max-w-xl mx-auto">{subtitle}</p>
          )}
        </div>
      )}
