      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 items-start justify-items-center text-center lg:text-left lg:justify-items-start">
          {benefits.map((item, idx) => (
            <div
              key={idx}
              className="flex flex-col lg:flex-row items-center lg:items-start gap-4 group cursor-default"
            >
              ...
              <div className="space-y-1">
                ...
                <p className="font-inter text-xs text-medium-gray">{item.subtitle}</p>
              </div>
            </div>
          ))}
        </div>
