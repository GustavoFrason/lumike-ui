      ...
      <div className="bg-white p-6 rounded-2xl border border-zinc-100 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-1.5">
            <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Vendedor</label>
            <select 
                  ...
                  <tr key={order.id} className="hover:bg-zinc-50/50 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-zinc-700">{seller?.name || 'Administrador'}</span>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 text-center">
                      <span className={cn(
                        ...
                        {order.status === 'paid' || order.status === 'completed' ? 'Paga' : 'Pendente'}
                      </span>
                    </td>
                  </tr>
                );
...
function MetricCard({ title, value, icon, description, gradient }: { 
  title: string; 
  value: string; 
  ...
  return (
    <div className={cn("bg-linear-to-br p-6 rounded-2xl border border-zinc-100 shadow-sm group hover:shadow-md transition-all", gradient)}>
