...
import { accessoryPurchasesService, AccessoryPurchase } from '@/lib/services/accessory-purchases.service';
                        ...
                        <tbody className="divide-y">
                            {items.map((item) => (
                                <tr key={item.id} className="hover:bg-zinc-50">
                                    ...
                                    <td className="p-4"><span className="bg-zinc-100 px-2 py-1 rounded text-xs font-medium">{item.type}</span></td>
                            ...
                            {items.length === 0 && (
                                <tr>
                                    <td colSpan={7} className="p-8 text-center text-zinc-400">Nenhum registro encontrado.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
