  ...
  if (!customer) {
    return (
      <div className="text-center py-12">
        ...
        <Link
          href="/admin/clientes"
          className="text-[var(--lumike-gold)] hover:underline mt-2 inline-block"
        >
          Voltar para lista
        </Link>
      </div>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border">
              ...
              <p className="text-xl font-semibold text-zinc-700">{lastOrderDate}</p>
            </div>
            <div className="bg-white p-4 rounded-xl shadow-sm border">
              <div className="flex items-center gap-2 text-zinc-500 mb-1">
                <div className="text-xs font-medium uppercase tracking-wider">Ticket Médio</div>
              </div>
              <p className="text-xl font-semibold text-zinc-700">{formatCurrency(averageTicket)}</p>
            </div>
          </div>
