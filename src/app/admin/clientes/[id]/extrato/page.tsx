                ...
                <CardContent className="p-0">
                        ...
                        <TableBody>
                            ...
                            {data.transactions.map((t, i) => (
                                <TableRow key={i}>
                                    ...
                                    <TableCell className={`text-right font-semibold ${t.running_balance > 0 ? 'text-red-700' : 'text-blue-700'}`}>
                    ...
                    <div className="p-6 bg-gray-50 border-t flex justify-end print:bg-white print:border-t-2">
                        <div className="text-right">
                            ...
                            <div className={`text-3xl font-bold mt-1 ${data.current_balance > 0 ? 'text-red-600' : 'text-blue-600'}`}>
