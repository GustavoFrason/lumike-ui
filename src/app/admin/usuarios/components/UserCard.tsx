  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-zinc-100 shadow-sm hover:shadow-md transition-all group">
      <div className="flex items-start justify-between mb-4">
        ...
        <button
          onClick={() => onEdit(user)}
          className="p-2 text-zinc-400 hover:text-(--lumilee-gold) hover:bg-orange-50 rounded-lg transition-colors"
        >
      ...
      <div className="space-y-3 pt-4 border-t border-zinc-50">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-bold text-(--lumilee-gold)">{user.commission_rate}%</span>
        </div>
        <div className="flex items-center justify-between text-sm">
      ...
      <div className="mt-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 bg-zinc-50 border border-zinc-100 rounded-xl text-xs font-bold text-zinc-600 hover:bg-(--lumilee-gold) hover:text-white hover:border-(--lumilee-gold) transition-all group-hover:bg-zinc-100"
        >
