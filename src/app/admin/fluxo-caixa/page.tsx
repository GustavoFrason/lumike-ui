...
export default function FluxoCaixaPage() {
    ...
    const columns: Column<any>[] = [
        ...
        },
        {
            ...
            header: 'Responsável',
            render: (item) => (
                <span className="text-xs">{item.users?.name || 'Sistema'}</span>
            )
        }
    ];
        ...
        <section className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-zinc-500">Acompanhamento de entradas e saídas reais do seu negócio.</p>
                </div>
                <div className="flex items-center gap-4">
                    ...
                    <div className="bg-white p-4 rounded-xl border border-zinc-100 shadow-sm flex flex-col items-end">
                        <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Saldo em Caixa</span>
            ...
            {stats && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white p-6 rounded-xl border border-zinc-100 shadow-sm">
                        <h3 className="text-lg font-semibold mb-4 text-gray-800">Receitas vs Despesas (30 dias)</h3>
            ...
            <div className="bg-amber-50 p-4 rounded-lg border border-amber-200 flex items-start gap-3">
                ...
                <p className="text-sm text-amber-800">
                    <strong>Nota:</strong> O Fluxo de Caixa começou a ser registrado hoje. Vendas e estornos realizados anteriormente não aparecem nesta lista, mas os totais no dashboard continuam corretos considerando o histórico legado.
                </p>
            </div>
