  ...
  return (
    <div className="max-w-[148mm] mx-auto p-8 bg-white text-black font-serif border-4 border-double border-[var(--lumike-gold)] print:max-w-none print:w-full print:border-4">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold tracking-widest text-[var(--lumike-taupe-dark)] mb-2">
          LUMIKE
        </h1>
        <p className="text-xs tracking-[0.3em] uppercase mb-6">Semijoias & Acessórios</p>
        <h2 className="text-2xl border-t border-b border-[var(--lumike-gold)] py-2 inline-block px-8">
      ...
      <div className="space-y-6 text-center">
        <p className="text-lg">
          Certificamos que as peças adquiridas no pedido <strong>#{order.id}</strong> possuem
          garantia de <strong>1 (um) ano</strong> contra defeitos de fabricação e banho.
        </p>

        <div className="bg-[var(--lumike-bg)] p-4 rounded text-left mx-auto max-w-md border border-[var(--lumike-taupe)]/20">
          <p className="font-bold mb-2 text-center text-[var(--lumike-taupe)]">
            DETALHES DA COMPRA
          </p>
          <div className="text-sm space-y-1">
            ...
            <p>
              <strong>Data da Compra:</strong> {formatDate(order.created_at)}
            </p>
            <p>
              <strong>Válido até:</strong> {formatDate(expirationDate.toISOString())}
            </p>
        ...
        <div className="text-sm text-zinc-600 max-w-lg mx-auto space-y-2 mt-8 text-justify">
          ...
          <p>
            1. Esta garantia cobre exclusivamente o desprendimento total ou parcial do banho e
            fechos.
          </p>
          <p>
            2. Não estão cobertos danos causados por mau uso, como: arranhões, quebras, contato com
            produtos químicos (perfumes, cremes, limpeza), água do mar ou piscina.
          </p>
