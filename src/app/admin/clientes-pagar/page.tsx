...
import { ChevronDown, ChevronUp, DollarSign, Send, Phone, MessageCircle } from 'lucide-react';
        ...
        <div className="space-y-4">
          {debtors.map((debtor) => (
            <div
              ...
              className="bg-white rounded-lg border border-zinc-200 overflow-hidden shadow-sm"
            >
              <div
                      ...
                      <div className="bg-white p-3 rounded border border-zinc-200 flex justify-between items-center text-sm">
                        ...
                        {payingOrderId === order.id ? (
                          ...
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              startPayment(order.id, order.amount);
                            }}
