    ...
    if (outOfStockFavorites.length === 0) {
        return (
            <div className="text-center py-12 bg-white border border-light-gray">
                ...
                <h2 className="text-xl font-playfair font-bold text-deep-black mb-2">Sem alertas de estoque</h2>
                <p className="text-medium-gray mb-6">Todos os seus favoritos estão disponíveis ou você ainda não favoritou itens esgotados.</p>
                <Link href="/minha-conta/favoritos" className="inline-flex items-center gap-2 text-primary-gold font-bold uppercase text-xs tracking-widest hover:underline">
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <div className="bg-primary-gold/10 px-4 py-2 rounded-full hidden md:block">
                    <p className="text-xs text-primary-gold font-bold uppercase tracking-widest">
                        {outOfStockFavorites.length} {outOfStockFavorites.length === 1 ? 'Item monitorado' : 'Itens monitorados'}
                    </p>
                </div>
            </div>
            ...
            <div className="bg-zinc-50 border border-zinc-200 p-6 rounded-sm mb-8">
                <div className="flex gap-4 items-start">
                    ...
                    <div>
                        <p className="text-sm font-bold text-deep-black uppercase tracking-wider">Como funciona?</p>
                        <p className="text-sm text-medium-gray mt-1 leading-relaxed">
                            Nós monitoramos seus favoritos acima. Assim que qualquer um desses itens retornar ao nosso estoque,
                            você verá um aviso destacado aqui e em sua página inicial.
                        </p>
                    </div>
                </div>
            </div>
