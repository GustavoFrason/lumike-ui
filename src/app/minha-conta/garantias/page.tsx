    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-medium-gray text-sm">Acesse os certificados digitais de autenticidade das suas joias.</p>
            </div>
            ...
            <div className="space-y-4">
                ...
                <Card className="p-6 bg-white border border-light-gray flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-playfair text-lg font-bold text-deep-black">Anel Solitário Ouro 18k</h3>
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        <Button variant="outline" className="flex-1 md:flex-none gap-2 text-xs uppercase tracking-wider font-bold h-10">
                ...
                <div className="text-center py-10">
                    <p className="text-sm text-medium-gray">
                        ...
                        <a href="#" className="text-deep-black font-bold ml-1 underline">Fale com nosso concierge.</a>
                    </p>
                </div>
            </div>
        </div>
