      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-light-gray pb-6">
        <div>
          ...
          <p className="text-medium-gray text-sm">
            {favorites.length} {favorites.length === 1 ? 'item salvo' : 'itens salvos'} na sua lista
            de desejos.
          </p>
        </div>
      </div>
      ...
      {favorites.length > 0 ? (
        ...
        <div className="bg-white border border-light-gray p-12 text-center space-y-6">
          ...
          <div className="max-w-xs mx-auto space-y-2">
            ...
            <p className="text-medium-gray text-sm">
              Você ainda não salvou nenhum produto como favorito. Explore nossa coleção e encontre
              algo especial!
            </p>
          </div>
          <Link
